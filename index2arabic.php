...
<html lang="en">
  ...
  <body>
    ...
    <header>
      <div class="container">
        <div class="logo">
          <a href="E-Learning/arabic/indexarabic.html"> One<span>Py</span>One </a>
        </div>
        <div class="links">
          <ul>
            ...
            <li><a href="E-Learning/arabic/contactarabic.html">تواصل معانا</a></li>
          </ul>
        </div>
        <div class="button">
          <div class="login">
            <a
              href="index2arabic.php"
              >تسجيل الدخول</a
            >
          </div>
          <div class="lang">
            <a href="E-Learning/english/index.html">EN</a>
          </div>
        </div>
    ...
    <div class="login-page">
      <div class="form">
        <form action="loginarabic.php" method="post" class="login-form">
          <h2>مرحبا بك في <span>One<span>Py</span>One</span></h2>
          ...
          <a href="signuparabic.php" class="ca"><span>ليس لديك حساب ؟</span> اشترك الان</a>
        </form>
      </div>
